...
[![Build Status on Linux](https://travis-ci.org/duggan/pontoon.png?branch=master)](https://travis-ci.org/duggan/pontoon)
[![Build status on Windows](https://ci.appveyor.com/api/projects/status/fj67qt2abc95i9ay?svg=true)](https://ci.appveyor.com/project/bendtherules/pontoon)
